"""
nohup python3 fgsm_apply_resnet.py > "*term_output_resnet_fgsm_cifar_0509_2109.txt" 2>&1 &
nohup python3 fgsm_apply_resnet.py > "*term_output_resnet_fgsm_imagenet_0509_2128.txt" 2>&1 &
"""
